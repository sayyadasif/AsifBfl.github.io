...
namespace TKMS.Service.Interfaces
{
    ...
    public interface IFileService : IFileProvider
    {
        ...
        /// <summary>
        /// Creates or overwrites a document file in the specified path
        /// </summary>
        /// <param name="path">The path and name of the file to create</param>
        ResponseModel CreateDocumentFile(Document document);
        ...
        /// <returns></returns>
        dynamic DownloadDocuments(List<Document> documents);
    }
}