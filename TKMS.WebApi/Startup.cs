...
using TKMS.WebApi.Attributes;

namespace TKMS.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.OperationFilter<OptionalRouteParameter>();
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Tkms.WebAPI", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (env.IsDevelopment())
            {
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Tkms.WebAPI"));
            }
            else
            {
                app.UseSwaggerUI(c => c.SwaggerEndpoint("../swagger/v1/swagger.json", "Tkms.WebAPI"));
